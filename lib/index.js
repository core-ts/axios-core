...
var HttpRequest = (function () {
  ...
  HttpRequest.prototype.get = function (url, options) {
    return Promise.resolve(this.axios.get(url, options ? options : this.getOptions())
      .then(function (_a) {
      var data = _a.data;
      return data;
    })
  ...
  HttpRequest.prototype.delete = function (url, options) {
    return Promise.resolve(this.axios.delete(url, options ? options : this.getOptions())
      .then(function (_a) {
      var data = _a.data;
      return data;
    })
  ...
  HttpRequest.prototype.post = function (url, obj, options) {
    return Promise.resolve(this.axios.post(url, obj, options ? options : this.getOptions())
      .then(function (_a) {
      var data = _a.data;
      return data;
    })
  ...
  HttpRequest.prototype.put = function (url, obj, options) {
    return Promise.resolve(this.axios.put(url, obj, options ? options : this.getOptions())
      .then(function (_a) {
      var data = _a.data;
      return data;
    })
  ...
  HttpRequest.prototype.patch = function (url, obj, options) {
    return Promise.resolve(this.axios.patch(url, obj, options ? options : this.getOptions())
      .then(function (_a) {
      var data = _a.data;
      return data;
    })
